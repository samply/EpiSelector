        ...
        <Card sx={{ width: "100%", height: "100%", borderRadius: '10px 10px 10px 10px' }}>
            ...
            <CardContent sx={{ backgroundColor: "white", width: "100%", height: "59%" }}>
                ...
                <div style={{ height: "13%", display: "flex", float: "right", gap: "3%", width: "42%", marginRight: "3%" }}>
                    <Link style={{ textDecoration: "none" }} to='/Matchingvariablen'><Button sx={{ height: "100%", width: "auto", borderColor: "#1d4189", "&:hover": { backgroundColor: "white", borderColor: "#1d4189" }, color: "#1d4189" }} variant="outlined"><ArrowBackIcon />Zurück</Button></Link>
                    ...
                    <Link style={{ textDecoration: "none" }} to='/FälleKontrollen' onClick={() => visitedSite("fällekontrollen")}><Button sx={{ height: "100%", width: "auto", color: "white", border: "none", backgroundColor: "#1d4189", "&:hover": { backgroundColor: "#1d4189" } }} variant="filled">Weiter <ArrowForwardIcon /></Button></Link>
